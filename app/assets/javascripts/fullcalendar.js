    ...
    var ListViewGrid = Grid.extend({
        ...
        fgSegHtml: function(seg) {
            ...
            return '<tr class="' + classes.join(' ') + '">' +
                ...
                '</td>' :
                    '') +
                    '<td><div class="tile-block tile-aqua"'+ (bgColor ? ' style="margin: 3px; border-radius: 0px;color: #fff;background-color:' + bgColor + '"' : 'style="color: #fff;margin: 3px; border-radius: 0px"')+
                '><div class="tile-header" style="padding-top: 3px; padding-bottom: 3px;"><i class="entypo-check"></i>'+
                    ' <a '+ (url ? ' href="' + htmlEscape(url) + '"' : '') + '>'+htmlEscape(seg.event.title || '')+' <span>'+timeHtml || ''+' </span> </a> </div></div></td>'+
                '</tr>';
        }
